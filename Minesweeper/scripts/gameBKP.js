...
{
    // alert("here.. ");
    document.getElementById('grid').innerHTML = getGrid() ;
}
/******************************************************************************/
function getGrid()
{
...
function startGame()
{
    ...
    isGameEnded     = false ;
    playerName      = prompt ("What's your name ? ","Player1");
...
function eventHandler(e) {
    ...
    if(checkGameOver()){
        statusMessage   = "Game over.You won." ;
        updateStatusMessage(statusMessage) ;
        isGameEnded = true ;
    }
    return false ;
